...
each prime factor p, the ring Z_p has three cube roots of unity if its totient,
p-1, is divisible by 3: 1, g^[(p-1)/3], g^[2(p-1)/3] where g is a primitive
root of Z_p. Otherwise, there is only one cube root of unity, 1.
